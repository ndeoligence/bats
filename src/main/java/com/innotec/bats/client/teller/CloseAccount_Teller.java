...
public class CloseAccount_Teller extends JPanel
{
	...
	public CloseAccount_Teller()
	{
		...
		JButton btnUnblock = new JButton("Close Acc");
		...
		sl_panel_1.putConstraint(SpringLayout.WEST, btnCancel, 356, SpringLayout.EAST, btnUnblock);
		...
		sl_panel_1.putConstraint(SpringLayout.EAST, btnUnblock, -849, SpringLayout.EAST, panel_1);
