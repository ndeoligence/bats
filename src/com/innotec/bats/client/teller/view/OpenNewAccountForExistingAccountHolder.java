...
public class OpenNewAccountForExistingAccountHolder extends JPanel implements ActionListener
{
	...
	public OpenNewAccountForExistingAccountHolder(JPanel framePanel, AccountHolder accountHolder)
	{
		...
		chckbxSavingsAccount = new JCheckBox("Savings Account");
		...
		chckbxCreditCard = new JCheckBox("Credit Card");
		...
		sl_panel_1.putConstraint(SpringLayout.SOUTH, chckbxCreditCard, 0, SpringLayout.SOUTH, lblAccountType);
		sl_panel_1.putConstraint(SpringLayout.SOUTH, chckbxSavingsAccount, 0, SpringLayout.SOUTH, lblAccountType);
		sl_panel_1.putConstraint(SpringLayout.SOUTH, chckbxCurrentAccount, 0, SpringLayout.SOUTH, lblAccountType);
		sl_panel_1.putConstraint(SpringLayout.WEST, chckbxCreditCard, 23, SpringLayout.EAST, chckbxSavingsAccount);
		sl_panel_1.putConstraint(SpringLayout.EAST, chckbxCreditCard, -383, SpringLayout.EAST, panel_1);
		sl_panel_1.putConstraint(SpringLayout.WEST, chckbxSavingsAccount, 25, SpringLayout.EAST, chckbxCurrentAccount);
	...
	public void actionPerformed(ActionEvent acEvent)
	{
		...
		if(rdbtnWithdrawalMax.isSelected())
		{
			...
			rdbtnTransferMaxR.setSelected(true);
		}
