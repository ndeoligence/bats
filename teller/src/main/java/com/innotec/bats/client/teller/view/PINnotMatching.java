...
public class PINnotMatching extends JDialog implements ActionListener
{
	...
	public static void main(String[] args)
	{
		try
		{
			PINnotMatching dialog = new PINnotMatching();
	...
	public PINnotMatching()
	{
		...
		{
			lblPinIncorrect = new JLabel("PIN's DO NOT CORRELATE!");
